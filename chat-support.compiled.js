...
function CSMessage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: l.href,
    className: "cs-link",
    onClick: () => goCS(l.href + (l.href.indexOf("?") === -1 ? "?" : "&") + "ret=ChatSupport.html")
...
function ChatSupportScreen() {
  ...
  function pickTopic(t) {
    ...
    setStore(s => ({
      ...s,
      messages: s.messages.map(m => m.chips ? {
        ...m,
        chips: false
      } : m)
    }));
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "cs-screen",
    "data-screen-label": "Chat Support (mobile)"
    ...
    className: "cs-id"
  }, /*#__PURE__*/React.createElement("h1", null, CS_AGENT.name), /*#__PURE__*/React.createElement("span", {
    className: "cs-status"
  }, CS_AGENT.status)), /*#__PURE__*/React.createElement("button", {
    className: "cs-more",
    ...
    size: 22,
    color: "var(--gray-900)"
  }))), store.ticket && /*#__PURE__*/React.createElement("div", {
    className: "cs-ticket",
    role: "status"
  }, /*#__PURE__*/React.createElement(DSCS.IconifyIcon, {
    name: "lucide:ticket",
    size: 16,
    color: "var(--brand-navy)"
  }), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("b", null, "Ticket #", store.ticket), " is open — we'll reply here and by email.")), /*#__PURE__*/React.createElement("div", {
    className: "cs-body",
    ref: bodyRef
  }, /*#__PURE__*/React.createElement("div", {
    className: "cs-daychip"
  }, /*#__PURE__*/React.createElement("span", null, fmtDayCS(msgs[0].ts))), /*#__PURE__*/React.createElement("div", {
    className: "cs-hours"
  }, /*#__PURE__*/React.createElement(DSCS.IconifyIcon, {
    name: "lucide:clock",
    size: 14,
    color: "var(--gray-500)"
  }), /*#__PURE__*/React.createElement("span", null, "Our team is online Mon–Fri, 9am–6pm UK time")), msgs.map((m, i) => {
    const prev = msgs[i - 1],
      next = msgs[i + 1];
    ...
    className: "cs-opt-label"
  }, "Start a new conversation"), /*#__PURE__*/React.createElement("span", {
    className: "cs-opt-sub"
  }, "Clears this thread on this device"))), /*#__PURE__*/React.createElement("button", {
    type: "button",
