...
const MY_COURSES = [
  { image: IMG.logo, level: "All Levels", title: "PROfinity Membership", description: "Ongoing protocols, weekly demos, marketing resources, and community support.", progress: 14, cta: "Continue learning", active: true, slug: "profinity-membership" },
...
function goToCourse(c) {
  const url = c.slug === "profinity-membership"
    ? "CourseLandingWeb.html"
    : c.slug
