...
function navigateEW(label) {
  var u = {
    ...
    Profile: "ProfileMobile.html",
    "My Learning": "LearningMobile.html",
    Community: "CommunityMobile.html",
    Agent: "AgentMobile.html"
  }[label];
  if (u) goEW(u);
}
...
const EVENTS_LIST = [...ewTuesdaysBetween(new Date(2026, 7, 4), new Date(2026, 11, 31)).map((d, i) => ({
  id: "tt" + i,
...
function EwCalendar({
  ...
  }, EW_MONTHS[cur.m], " ", cur.y), /*#__PURE__*/React.createElement("button", {
    className: "ev-cal-nav",
  ...
  }, /*#__PURE__*/React.createElement("b", null, p.d), /*#__PURE__*/React.createElement("i", null, EW_MONTHS[cur.m].slice(0, 3).toUpperCase())), /*#__PURE__*/React.createElement("span", {
    className: "ev-cal-item-tx"
  }, /*#__PURE__*/React.createElement("span", {
    className: "t"
  }, p.ev.title), /*#__PURE__*/React.createElement("span", {
    className: "s"
  }, p.ev.time), /*#__PURE__*/React.createElement(EwStatusPill, {
    st: ewStatusOf(p.ev, statusMap)
  })), /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:chevron-right",
    size: 19,
    color: "var(--gray-450)"
...
function EventsList({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ev-search"
  }, /*#__PURE__*/React.createElement(DSEW.Icon, {
    name: "search",
    size: 20,
    color: "var(--gray-450)"
  ...
  }))))), view === "calendar" && /*#__PURE__*/React.createElement(EwCalendar, {
    onOpen: onOpen,
    cur: cur,
    setCur: setCur
    ...
    }, "View Event", /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
...
function ewIsFree() {
  ...
  try {
    return (PFAEW && PFAEW.getUserTier ? PFAEW.getUserTier() : "free") === "free";
  } catch (e) {
    return false;
  }
}
...
function EventDetail({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:calendar",
    size: 20,
    color: "var(--brand-navy)"
  }), d.date), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:clock",
    size: 20,
    color: "var(--brand-navy)"
    ...
    className: "ev-faces"
  }, CALL_PEOPLE.concat(CALL_PEOPLE.slice(0, 3)).map((p, i) => /*#__PURE__*/React.createElement(DSEW.Avatar, {
    key: i,
    name: p.name,
    src: p.avatar,
    size: 32
    ...
    onClick: act
  }, cta.label, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: cta.icon,
    size: 18,
    ...
    className: "ev-help"
  }, /*#__PURE__*/React.createElement("span", null, "Contact Support - We are here to help if you have any questions about this event."), /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:chevron-right",
    size: 22,
    color: "var(--gray-450)"
  })))), gate && /*#__PURE__*/React.createElement(MembersGate, {
    onClose: () => setGate(false),
    onUpgrade: () => goEW("MembershipTier.html")
...
function LSStage({
  ...
  }, p.name, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
...
function LSTopBar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ls-topbar-brand",
    src: "assets/profinity-icon-twist.png",
    alt: "PROfinity"
  }), /*#__PURE__*/React.createElement("span", {
    className: "ls-topbar-title"
...
function LSCheckout({
  ...
  const goCourse = () => {
    goEW(`CourseWeb.html?${new URLSearchParams({
      title: product.title,
      instr: "Dr. Tim Pearce",
      pct: 0
    })}`);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tx"
  }, /*#__PURE__*/React.createElement("b", null, "Visa ending 4242"), /*#__PURE__*/React.createElement("span", null, "Expires 08/28")), /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:check-circle-2",
    size: 18,
    color: "var(--brand-navy)"
  })), /*#__PURE__*/React.createElement("button", {
...
function LiveStream({
  ...
  const [msgs, setMsgs] = useStateEW(() => LS_CHAT_SEED.map((m, i) => Object.assign({
    id: i
  }, m)));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ls-chatpanel" + (chatOpen ? " open" : ""),
    "aria-hidden": !chatOpen
  }, /*#__PURE__*/React.createElement("div", {
    className: "ls-chatpanel-scrim",
    onClick: () => setChatOpen(false)
  }), /*#__PURE__*/React.createElement("aside", {
    className: "ls-chatpanel-inner",
    role: "dialog",
    "aria-label": "Live chat"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ls-chatpanel-head"
  }, /*#__PURE__*/React.createElement("span", null, "Live Chat"), /*#__PURE__*/React.createElement("button", {
    className: "ls-chatpanel-close",
...
function WaitingRoom({
  ...
  const [msgs, setMsgs] = useStateEW(() => [Object.assign({
    id: 0
  }, EW_ARRIVALS[0])]);
  useEffectEW(() => {
    let i = 1;
    const t = setInterval(() => {
      setMsgs(m => m.slice(-4).concat([Object.assign({
        id: Date.now()
      }, EW_ARRIVALS[i % EW_ARRIVALS.length])]));
      i++;
    }, 2600);
    return () => clearInterval(t);
  }, []);
  ...
  }, /*#__PURE__*/React.createElement("b", null, watching, " clinicians"), " are already watching. Click below to join — no approval needed."), /*#__PURE__*/React.createElement("p", {
  ...
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:check",
    size: 16,
    color: "var(--success)"
  }), "Step-by-step technique demonstration"), /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:check",
    size: 16,
    color: "var(--success)"
  }), "Live Q&A with the panel"), /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(DSEW.IconifyIcon, {
    name: "lucide:check",
    size: 16,
    color: "var(--success)"
...
function EventsWebApp() {
  ...
  const [cur, setCur] = useStateEW({
    y: EW_TODAY.getFullYear(),
    m: EW_TODAY.getMonth()
  });
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: vars
  }, screen !== "call" && screen !== "waiting" && /*#__PURE__*/React.createElement(TopNavEW, {
    active: "Home",
    user: ME_EW,
  ...
  }), screen === "list" && /*#__PURE__*/React.createElement(EventsList, {
    onBack: () => goEW("NewsfeedWeb.html"),
    onOpen: open,
    view: view,
    setView: setView,
    cur: cur,
...
ReactDOM.createRoot(document.getElementById("pf-root")).render(/*#__PURE__*/React.createElement(EventsWebApp, null));
