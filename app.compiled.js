...
if (typeof window !== "undefined" && !window.PFHashtags) {
  (function () {
    ...
    function getAll() {
      ...
      var missing = DEFAULT_HASHTAGS.filter(function (t) {
        return !have[t.slug];
      });
      if (missing.length) {
...
const TIM = {
  name: "Dr Tim Pearce",
  avatar: "https://yt3.googleusercontent.com/HlxBYCZyQaKVlrTEJBC-7kM4rrkRH3i9lY9RJvAFPy5KqTEOs8nd8lWohPvrAS2XzIxjsHso=s900-c-k-c0x00ffffff-no-rj",
...
const CONFIDENCE_POST_6 = confidencePost({
  ...
  comment: {
    name: "Priya Shah",
    text: "This is exactly why we're all here — congratulations on posting it!",
    likes: "14",
    time: "2h",
    avatar: "assets/avatar-priya-shah.jpg"
  }
...
const CONFIDENCE_POST_7 = confidencePost({
  ...
  comment: {
    name: "Nurse Beth",
    text: "Saying this out loud to patients is harder than any injection technique, honestly.",
    likes: "12",
    time: "5h",
    avatar: "assets/avatar-nurse-beth.jpg"
  }
...
const CONFIDENCE_POST_8 = confidencePost({
  ...
  comment: {
    name: "Jade Osei",
    text: "Doing this too from now on, what a good idea.",
    likes: "8",
    time: "8h"
  }
});
const CONFIDENCE_POST_9 = confidencePost({
  ...
  comment: {
    name: "Dr Owen Clarke",
    text: "Five years in and mine still does it sometimes. You're not alone in this.",
    likes: "22",
    time: "18h"
  }
});
const CONFIDENCE_POST_10 = confidencePost({
  ...
  time: "1 Day Ago",
  chTime: "20h",
  hashtags: ["confidence", "masterclass"],
  sample: {
    type: "video",
    poster: IMG.p2img3,
    duration: "9:40"
  ...
  comment: {
    name: "Mark Ellis",
    text: "The bit about the first year plateau was the whole panel for me.",
    likes: "19",
    time: "16h",
    avatar: "assets/avatar-mark-ellis.jpg"
  }
...
const CONFIDENCE_POST_11 = confidencePost({
  ...
  time: "2 Days Ago",
  chTime: "1d",
  hashtags: ["confidence", "milestone"],
  media: masteryGallery(6),
  ...
  comment: {
    name: "Dr. Sarah Collins",
    text: "Ten posts in and this quality — so glad you stopped deleting the drafts.",
    likes: "17",
    time: "22h",
    avatar: "assets/avatar-sarah-collins.jpg"
  }
...
const CONFIDENCE_POST_12 = confidencePost({
  ...
  comment: {
    name: "Ruth Adeyemi",
    text: "\"I just start anyway\" might be the most useful sentence in this whole channel.",
    likes: "15",
    time: "1d"
  }
});
const CONFIDENCE_POST_13 = confidencePost({
  ...
  time: "3 Days Ago",
  chTime: "2d",
  hashtags: ["confidence", "patientfeedback"],
  media: [IMG.p3img1],
  ...
  comment: {
    name: "Chloe Bennett",
    text: "This is the kind of feedback that means more than any before-and-after.",
    likes: "10",
    time: "2d"
  }
});
const CONFIDENCE_POST_14 = confidencePost({
  ...
  comment: {
    name: "Dr Faisal Rahman",
    text: "Needed exactly this before tomorrow's list, thank you Mark.",
    likes: "13",
    time: "1d"
  }
});
const CONFIDENCE_POST_15 = confidencePost({
  ...
  comment: {
    name: "Ben Foster",
    text: "The relief of reading this as someone one year in is enormous.",
    likes: "16",
    time: "3d"
  }
});
const CONFIDENCE_POST_16 = confidencePost({
  ...
  time: "4 Days Ago",
  chTime: "4d",
  hashtags: ["confidence", "growth"],
  media: masteryGallery(11),
  ...
  comment: {
    name: "Dr Amir Khan",
    text: "The ones you learn from are always more useful to the rest of us anyway.",
    likes: "12",
    time: "3d",
    avatar: "assets/avatar-amir-khan.jpg"
  }
...
const CONFIDENCE_POST_17 = confidencePost({
  ...
  comment: {
    name: "Layla Hassan",
    text: "Every single time, and it's never actually about that. Hope the rest of your day was better.",
    likes: "14",
    time: "4d"
  }
});
const CONFIDENCE_POST_18 = confidencePost({
  ...
  comment: {
    name: "Priya Shah",
    text: "Stealing this for my own treatment room, thank you Beth.",
    likes: "11",
    time: "4d",
    avatar: "assets/avatar-priya-shah.jpg"
  }
...
const CONFIDENCE_POST_19 = confidencePost({
  ...
  comment: {
    name: "Nurse Beth",
    text: "This is exactly the kind of honesty that makes this channel worth paying for.",
    likes: "21",
    time: "4d",
    avatar: "assets/avatar-nurse-beth.jpg"
  }
...
const CONFIDENCE_POST_20 = confidencePost({
  ...
  comment: {
    name: "Dr Rachel Voss",
    text: "This is why we all keep showing up in this channel. Thank you for coming back to say it.",
    likes: "20",
    time: "5d"
  }
});
const FREEDOM_POST_6 = freedomPost({
  ...
  time: "4 Hours Ago",
  chTime: "4h",
  hashtags: ["freedom", "renovation"],
  media: masteryGallery(16),
  ...
  comment: {
    name: "Leo Martins",
    text: "Over budget every single time, but it always looks worth it in the after shots.",
    likes: "11",
    time: "3h"
  }
});
const FREEDOM_POST_7 = freedomPost({
  ...
  comment: {
    name: "Dr Rachel Voss",
    text: "Made the same switch in January, wish I'd done it years earlier.",
    likes: "13",
    time: "6h"
  }
});
const FREEDOM_POST_8 = freedomPost({
  ...
  comment: {
    name: "Mark Ellis",
    text: "Which system is this? Ours is still held together with reminder texts.",
    likes: "14",
    time: "9h",
    avatar: "assets/avatar-mark-ellis.jpg"
  }
...
const FREEDOM_POST_9 = freedomPost({
  ...
  comment: {
    name: "Leo Martins",
    text: "Second one is always the hard one, third gets easier again once the systems exist.",
    likes: "12",
    time: "17h"
  }
});
const FREEDOM_POST_10 = freedomPost({
  ...
  comment: {
    name: "Dr Amir Khan",
    text: "Documenting the float count process alone would save my managers an hour a week.",
    likes: "16",
    time: "14h",
    avatar: "assets/avatar-amir-khan.jpg"
  }
...
const FREEDOM_POST_11 = freedomPost({
  ...
  comment: {
    name: "Ruth Adeyemi",
    text: "The delay is always longer than it should be, every time I've had to do it too.",
    likes: "13",
    time: "1d"
  }
});
const FREEDOM_POST_12 = freedomPost({
  ...
  comment: {
    name: "Chloe Bennett",
    text: "The consistency across all three locations is what really sells the rebrand.",
    likes: "12",
    time: "20h"
  }
});
const FREEDOM_POST_13 = freedomPost({
  ...
  comment: {
    name: "Dr Faisal Rahman",
    text: "Asked mine the same question this morning after reading this. Already saved 8%.",
    likes: "15",
    time: "2d"
  }
});
const FREEDOM_POST_14 = freedomPost({
  ...
  comment: {
    name: "Nurse Beth",
    text: "Handing this straight to my front desk tomorrow morning.",
    likes: "17",
    time: "1d",
    avatar: "assets/avatar-nurse-beth.jpg"
  }
...
const FREEDOM_POST_15 = freedomPost({
  ...
  comment: {
    name: "Dr Owen Clarke",
    text: "Promoting from within always pays off more than people expect it to.",
    likes: "10",
    time: "3d"
  }
});
const FREEDOM_POST_16 = freedomPost({
  ...
  comment: {
    name: "Dr Rachel Voss",
    text: "Cutting the underperforming lines is always the hardest financial decision to make.",
    likes: "9",
    time: "3d"
  }
});
const FREEDOM_POST_17 = freedomPost({
  ...
  comment: {
    name: "Leo Martins",
    text: "Done both — happy to jump on a call and walk you through the real trade-offs.",
    likes: "14",
    time: "4d"
  }
});
const FREEDOM_POST_18 = freedomPost({
  ...
  comment: {
    name: "Mark Ellis",
    text: "Eighteen months for three locations is an incredible pace — congratulations Beth.",
    likes: "19",
    time: "4d",
    avatar: "assets/avatar-mark-ellis.jpg"
  }
...
const FREEDOM_POST_19 = freedomPost({
  ...
  comment: {
    name: "Dr Amir Khan",
    text: "Always cheaper to retain than replace — learned that one the expensive way.",
    likes: "11",
    time: "4d",
    avatar: "assets/avatar-amir-khan.jpg"
  }
...
const FREEDOM_POST_20 = freedomPost({
  ...
  comment: {
    name: "Ben Foster",
    text: "The booth setup alone is worth copying, thanks for sharing the photos.",
    likes: "10",
    time: "5d"
  }
});
const INNER_POST_6 = innerPost({
  ...
  comment: {
    name: "Dr Naomi Reyes",
    text: "The earn-out is always the real negotiation — congratulations on number four.",
    likes: "22",
    time: "4h"
  }
});
const INNER_POST_7 = innerPost({
  ...
  comment: {
    name: "James Whitfield",
    text: "Wish I'd seen this before my own process — would have saved a huge amount of back and forth.",
    likes: "18",
    time: "8h"
  }
});
const INNER_POST_8 = innerPost({
  ...
  comment: {
    name: "Dr Tim Pearce",
    text: "The add-back disagreements are where most of these deals actually die — appreciate you sharing the detail.",
    likes: "24",
    time: "18h",
    avatar: "assets/avatar-drtim.png"
  }
...
const INNER_POST_9 = innerPost({
  ...
  comment: {
    name: "Dr Naomi Reyes",
    text: "Nine days is fast for that lender — glad the recommendation paid off.",
    likes: "14",
    time: "16h"
  }
});
const INNER_POST_10 = innerPost({
  ...
  comment: {
    name: "Dr Elena Vasquez",
    text: "The staged earn-out schedule is exactly the structure I've been trying to model for mine.",
    likes: "20",
    time: "22h"
  }
});
const INNER_POST_11 = innerPost({
  ...
  comment: {
    name: "Dr Naomi Reyes",
    text: "Every word of this. Took me almost a year to feel settled after my own exit.",
    likes: "21",
    time: "1d"
  }
});
const INNER_POST_12 = innerPost({
  ...
  comment: {
    name: "James Whitfield",
    text: "Keeping it internal like this is undervalued compared to chasing the highest external bid.",
    likes: "16",
    time: "2d"
  }
});
const INNER_POST_13 = innerPost({
  ...
  comment: {
    name: "Dr Tim Pearce",
    text: "Matches what I'm hearing from three separate brokers this month.",
    likes: "23",
    time: "2d",
    avatar: "assets/avatar-drtim.png"
  }
...
const INNER_POST_14 = innerPost({
  ...
  comment: {
    name: "Dr Elena Vasquez",
    text: "That gap is exactly why I'm not accepting the broker's first number on mine.",
    likes: "19",
    time: "3d"
  }
});
const INNER_POST_15 = innerPost({
  ...
  comment: {
    name: "Ruth Adeyemi",
    text: "Just sent my application in, hoping one of those three seats is still open.",
    likes: "15",
    time: "3d"
  }
});
const INNER_POST_16 = innerPost({
  ...
  comment: {
    name: "Dr Naomi Reyes",
    text: "Eighteen months is realistic and refreshing to hear compared to the six-month stories people usually tell.",
    likes: "20",
    time: "4d"
  }
});
const INNER_POST_17 = innerPost({
  ...
  comment: {
    name: "James Whitfield",
    text: "Structured one last year — happy to talk through the equity split we landed on.",
    likes: "13",
    time: "4d"
  }
});
const INNER_POST_18 = innerPost({
  ...
  comment: {
    name: "Dr Faisal Rahman",
    text: "This is why I now pay for a second legal opinion on every term sheet, no exceptions.",
    likes: "17",
    time: "5d"
  }
});
const INNER_POST_19 = innerPost({
  ...
  comment: {
    name: "Dr Tim Pearce",
    text: "Glad this is useful beyond the room — the 90-day plan is worth revisiting every acquisition.",
    likes: "16",
    time: "5d",
    avatar: "assets/avatar-drtim.png"
  }
...
const INNER_POST_20 = innerPost({
  ...
  comment: {
    name: "Dr Naomi Reyes",
    text: "The section on the mistakes that cost money was worth the whole quarter's membership alone.",
    likes: "25",
    time: "5d"
  }
});
...
function getUserTier() {
  try {
    return localStorage.getItem(PF_TIER_KEY) || "free";
  } catch (e) {
    return "free";
  }
}
function setUserTier(tier) {
  try {
    localStorage.setItem(PF_TIER_KEY, tier);
  } catch (e) {}
}
...
const SAMPLE_CAROUSEL_POST = {
  id: "ff_carousel1",
  author: TIM,
  withOthers: "Miranda Pearce and 6 others",
  time: "1h",
  hashtags: ["case-study", "protocol"],
  sample: {
    type: "carousel",
    images: [IMG.p5img1, IMG.p5img2, IMG.p5img3, IMG.p5img4, IMG.p5img5]
  },
...
const SAMPLE_PINNED_POLL_POST = {
  ...
  poll: {
    ...
    options: [{
      label: "Lip complications & rescue",
      pct: 38
    }, {
      label: "Tear trough assessment",
      pct: 27
    }, {
      label: "Jawline & chin planning",
      pct: 21
    }, {
      label: "Clinic pricing & consults",
      pct: 14
    }],
    votes: 2300
  },
...
const POLL_POST_2 = {
  ...
  poll: {
    ...
    options: [{
      label: "Vascular occlusion management",
      pct: 38
    }, {
      label: "Full-face liquid facelift planning",
      pct: 27
    }, {
      label: "Cannula vs needle decision tree",
      pct: 22
    }, {
      label: "Building patient confidence pre-treatment",
      pct: 13
    }],
    votes: 960
  },
...
const POLL_POST_3 = {
  ...
  poll: {
    ...
    options: [{
      ...
      label: "Full case walkthroughs",
      pct: 31
    }, {
      label: "Quick technique demos",
      pct: 24
    }, {
      label: "Guest specialist sessions",
      pct: 11
    }],
    votes: 1120
  },
...
const POLL_POST_4 = {
  ...
  poll: {
    ...
    options: [{
      label: "Complication management deep dive",
      pct: 36
    }, {
      label: "Consult scripting for nervous patients",
      pct: 26
    }, {
      label: "Advanced cannula technique",
      pct: 23
    }, {
      label: "Pricing & business systems",
      pct: 15
    }],
    votes: 890
  },
...
const FREE_CAROUSEL5_1 = {
  id: "ff_car5_1",
  author: TIM,
  withOthers: "Miranda Pearce and 9 others",
  time: "6h",
  hashtags: ["case-study", "patient"],
  sample: {
    type: "gallery",
    images: masteryGallery(0)
  },
...
const FREE_FEED_SEQUENCE = [...cycleSlots({
  text: TEXT_POST_1,
  sqImg: [SQUARE_IMG_POST_1],
  vertImg: [PORTRAIT_IMG_POST_1],
  carousel: [FREE_CAROUSEL5_1],
  ...
  text: TEXT_POST_2,
  sqImg: [SQUARE_IMG_POST_2],
  vertImg: [PORTRAIT_IMG_POST_2],
  carousel: [FREE_CAROUSEL5_2],
  sqVideo: [SQUARE_VIDEO_POST_2],
...
const CONFIDENCE_FEED_SEQUENCE = [...cycleSlots({
  text: TEXT_POST_1,
...
const MASTERY_FEED_SEQUENCE = [...cycleSlots({
  text: TEXT_POST_1,
...
const TIER_FEED_SEQUENCES = {
  free: FREE_FEED_SEQUENCE,
  confidence: CONFIDENCE_FEED_SEQUENCE,
  mastery: MASTERY_FEED_SEQUENCE,
  freedom: MASTERY_FEED_SEQUENCE,
  inner: MASTERY_FEED_SEQUENCE,
  admin: MASTERY_FEED_SEQUENCE
};
...
const ALL_FEED_SEQUENCE_POSTS = Object.values([LIVE_NOW_POST, SAMPLE_LONG_TEXT_POST, SAMPLE_CAROUSEL_POST, ...SAMPLE_PINNED_POSTS, ...FREE_FEED_SEQUENCE, ...CONFIDENCE_FEED_SEQUENCE, ...MASTERY_FEED_SEQUENCE].reduce((m, p) => {
  m[p.id] = p;
  return m;
}, {}));
...
function LeftRail() {
  return /*#__PURE__*/React.createElement("aside", {
    ...
    key: i,
    group: g
  })), /*#__PURE__*/React.createElement(Download, null));
}
...
function ptsPopupOn() {
  try {
    const s = JSON.parse(localStorage.getItem("pf-gamification")) || {};
    return s.pointsPopup !== false;
  } catch (e) {
    return true;
  }
}
...
function ensurePtsDocData() {
  ...
  ptsDocFetch = fetch(PTS_DOC_SRC).then(r => {
...
function warmPtsDoctor() {
  ensurePtsLottie().catch(() => {});
  ensurePtsDocData().catch(() => {});
}
...
function floatPoints(anchor, amount) {
  ...
  const anim = el.animate([{
    ...
    transform: "translate(-50%,calc(-100% - " + dy * 0.65 + "px)) scale(1)",
    opacity: 1,
    offset: 0.7
  }, {
...
function rewardShare(anchor) {
  ...
  if (eng && eng.awardPoints) {
    try {
      eng.awardPoints(SHARE_POINTS, "Shared a post", "evt_share_post");
      booked = true;
    } catch (e) {}
  }
  popPoints(anchor || null, SHARE_POINTS, {
    label: "Shared a post",
    actionId: "evt_share_post",
    sound: "post",
    booked
  });
}
...
function burstFrom(btn, key) {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    document.body.appendChild(el);
    const dx = (Math.random() - 0.5) * 96 * s,
      dy = (-56 - Math.random() * 74) * s;
    const anim = el.animate([{
...
function useReactionPicker(ref, reaction, onReact) {
  ...
  const show = () => {
    ...
    setPicker({
      bottom: window.innerHeight - r.top + 8 * scale,
      scale
    });
  };
  const scheduleHide = () => {
...
function ReactTrigger() {
  ...
  const open = () => {
    ...
    setAt({
      bottom: window.innerHeight - rect.top + 8 * scale,
      scale
    });
  };
  const scheduleHide = () => {
...
function WebImageCarousel({
  ...
  useEffect(() => {
    if (!fs) return;
    const onDocKey = e => {
      if (e.key === "Escape") setFs(false);else if (e.key === "ArrowRight") fsGo(fsIdx + 1);else if (e.key === "ArrowLeft") fsGo(fsIdx - 1);
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: wrap(() => openFullscreen(i))
  }))), multi && idx > 0 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "wc-arrow wc-prev",
    ...
    size: 22,
    color: "var(--brand-navy)"
  })), multi && idx < total - 1 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "wc-arrow wc-next",
    ...
    className: "mc-count"
  }, idx + 1, "/", total), multi && /*#__PURE__*/React.createElement(SlidingDots, {
    count: total,
    idx: idx
  }), heartNode, fs && /*#__PURE__*/React.createElement("div", {
    className: "sm-fs",
    ...
    src: src,
    alt: "Image " + (i + 1) + " of " + total
  }))), fsIdx > 0 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "wc-arrow wc-prev wc-fs-arrow",
    "aria-label": "Previous image",
    onClick: () => fsGo(fsIdx - 1)
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:chevron-left",
    size: 24,
    color: "var(--white)"
  })), fsIdx < total - 1 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "wc-arrow wc-next wc-fs-arrow",
    "aria-label": "Next image",
    onClick: () => fsGo(fsIdx + 1)
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:chevron-right",
...
const FOLLOW_REACTORS = [{
  name: "Daryll Cee",
  avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRl_iS6ah90lEufyitkFEND2e98ccufb7spcgCLbb2gY1vw7151sSqjaXGp&s=10",
  rxn: "like"
}, {
  name: "Marco Ricci",
  ...
  name: "Sofia Chen",
  avatar: "https://plus.unsplash.com/premium_photo-1689568126014-06fea9d5d341?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D",
  rxn: "heart"
}];
const RXN_BADGE = {
  like: {
...
function GalleryGrid({
  ...
  if (total >= 5) {
    ...
    const extra = total - 5;
    return /*#__PURE__*/React.createElement("div", {
      className: "sm-grid sm-grid-5plus"
    }, /*#__PURE__*/React.createElement("div", {
      className: "sm-grid-row"
    }, top.map((src, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      ...
      className: "sm-grid-row"
    }, bottom.map((src, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      className: "sm-grid-cell"
    }, /*#__PURE__*/React.createElement("img", {
      src: src,
      alt: "Image " + (i + 3) + " of " + total,
      onClick: onImageClick
    }), i === bottom.length - 1 && extra > 0 && /*#__PURE__*/React.createElement("span", {
      className: "sm-grid-more"
    }, "+", extra)))));
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "sm-grid sm-grid-" + total
  }, /*#__PURE__*/React.createElement("div", {
    className: "sm-grid-row"
  }, images.map((src, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
...
function WebReelModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "sm-reel-modal",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", {
    className: "sm-reel-modal-inner" + (vertical ? " vertical" : " square"),
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", {
    className: (vertical ? "sm-vertical sm-reel" : "sm-video sm-video-square") + (playing ? " playing" : ""),
    ...
    className: vertical ? "sm-controls" : "sm-video-controls",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("span", {
    className: "sm-time"
    ...
    className: "sm-fill" + (!vertical ? " sm-video-fill" : "")
  })), /*#__PURE__*/React.createElement("span", {
    className: "sm-time"
  }, "0:15")))), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "sm-reel-modal-close",
    "aria-label": "Close",
    onClick: onClose
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:x",
...
function SampleMedia({
  ...
  const webPlayerNode = webPlayerOpen && /*#__PURE__*/React.createElement(WebReelModal, {
    sample: sample,
    playing: playing,
  ...
  if (sample.type === "carousel") {
    return isWeb ? /*#__PURE__*/React.createElement(WebImageCarousel, {
  ...
  if (typeof window !== "undefined" && !window.PF_EMBED) {
    return /*#__PURE__*/React.createElement("div", {
      className: "sm-grid-wrap"
    }, /*#__PURE__*/React.createElement(GalleryGrid, {
      images: sample.images,
      onImageClick: wrap(null)
    }), heartNode);
  }
  const onScroll = () => {
...
function ReportedModal({
  ...
  }, "Reported"), /*#__PURE__*/React.createElement("div", {
    className: "saved-desc"
  }, "Thanks for letting us know. Our team will review this post and take action if it breaks our community guidelines."), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "saved-btn",
    style: {
...
function slimSharedPost(post) {
  ...
  const sample = sp ? {
    ...
    poster: sp.poster,
    image: sp.image,
    images: (sp.images || []).slice(0, 10),
    src: sp.src,
    ratio: sp.ratio,
    duration: sp.duration,
    aspect: sp.aspect
  } : undefined;
  const video = post.video && post.video.src ? {
    src: post.video.src,
  ...
  return {
    ...
    sample,
    video,
    liveNow: post.liveNow ? {
      viewers: post.liveNow.viewers,
...
const SHARE_TILE_TONES = {
  messages: "var(--brand-navy)",
  whatsapp: "#25D366",
  copy: "var(--ai-purple)",
  channel: "var(--brand-gold)",
  profile: "var(--info)",
  email: "var(--reaction-love)",
  more: "var(--gray-600)"
};
...
function SharePostQuote({
  ...
  if (full) {
    ...
    let mediaNode = null;
    if (vidSrc) {
      mediaNode = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
        className: "pf-shq-video",
        style: {
          aspectRatio: ratio
        }
      }, /*#__PURE__*/React.createElement(PFMediaVideo, {
      ...
      })), media.length > 0 && /*#__PURE__*/React.createElement(MediaCarousel, {
        images: media
      }));
    } else if (sp.type === "video" && sp.poster) {
      mediaNode = /*#__PURE__*/React.createElement("div", {
        className: "pf-shq-poster" + (sp.aspect === "square" ? " square" : "")
      }, /*#__PURE__*/React.createElement("img", {
        src: sp.poster,
        alt: ""
      }), /*#__PURE__*/React.createElement("span", {
        className: "pf-shq-play"
      }, /*#__PURE__*/React.createElement(IconifyIcon, {
        name: "fluent:play-16-filled",
        size: 26,
        color: "#fff"
      })), sp.duration && /*#__PURE__*/React.createElement("span", {
        className: "pf-shq-dur"
      }, sp.duration));
    } else if (sp.type === "vertical" && sp.image) {
      mediaNode = /*#__PURE__*/React.createElement("div", {
        className: "pf-shq-poster reel"
      }, /*#__PURE__*/React.createElement("img", {
        src: sp.image,
        alt: ""
      }), /*#__PURE__*/React.createElement("span", {
      ...
      mediaNode = /*#__PURE__*/React.createElement("div", {
        className: "pf-shq-poster"
      }, /*#__PURE__*/React.createElement("img", {
        src: post.liveNow.frame,
        alt: ""
      }), /*#__PURE__*/React.createElement("span", {
        className: "pf-shq-livebadge"
      }, /*#__PURE__*/React.createElement("i", null), "LIVE"), /*#__PURE__*/React.createElement("span", {
        className: "pf-shq-dur"
      }, /*#__PURE__*/React.createElement(IconifyIcon, {
        name: "lucide:eye",
        size: 12,
        color: "#fff"
      }), " ", post.liveNow.viewers));
    } else if (media.length > 0) {
      mediaNode = /*#__PURE__*/React.createElement(MediaCarousel, {
        images: media
      });
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "pf-shq-fhd"
    }, /*#__PURE__*/React.createElement(Avatar, {
      name: post.author.name,
      src: post.author.avatar,
      size: 40
    }), /*#__PURE__*/React.createElement("div", {
      className: "pf-shq-fhd-tx"
    }, /*#__PURE__*/React.createElement("span", {
      className: "pf-shq-fnm"
    }, post.author.name, /*#__PURE__*/React.createElement(IconifyIcon, {
      name: "lucide:badge-check",
      size: 15,
      color: "var(--info)"
    })), /*#__PURE__*/React.createElement("span", {
      className: "pf-shq-fmeta"
    }, post.time || "Just now", /*#__PURE__*/React.createElement("i", null, "·"), /*#__PURE__*/React.createElement(IconifyIcon, {
      name: "lucide:globe",
      size: 13,
      color: "var(--gray-500)"
    })))), post.body && /*#__PURE__*/React.createElement("div", {
      className: "pf-shq-fbody"
    }, /*#__PURE__*/React.createElement(ClampText, {
      text: post.body,
      lines: 2,
      more: "See more"
    })), kindOnly && /*#__PURE__*/React.createElement("div", {
      className: "pf-shq-fbody"
    }, /*#__PURE__*/React.createElement("div", {
      className: "pf-shq-kind"
    }, /*#__PURE__*/React.createElement("span", {
      className: "pf-shq-kind-tx"
    }, /*#__PURE__*/React.createElement(IconifyIcon, {
      name: post.poll ? "lucide:bar-chart-3" : post.questionnaire ? "lucide:help-circle" : "lucide:file-text",
      size: 15,
      color: "var(--brand-navy)"
    }), /*#__PURE__*/React.createElement("span", null, kindOnly)))), mediaNode && /*#__PURE__*/React.createElement("div", {
      className: "pf-shq-media"
    }, mediaNode));
  }
  ...
  const kind = post.liveNow ? {
    icon: "lucide:radio",
    label: "Live now · " + (post.liveNow.viewers || "") + " watching",
    thumb: post.liveNow.frame,
    live: true
  } : post.poll ? {
    icon: "lucide:bar-chart-3",
    label: "Poll · " + (post.poll.question || "")
  } : post.questionnaire ? {
    icon: "lucide:help-circle",
    label: "Quiz · " + (post.questionnaire.question || "")
  } : post.sample && sample.type !== "gallery" ? {
    icon: "lucide:play-circle",
    label: sample.type === "vertical" ? "Reel" : "Video" + (sample.duration ? " · " + sample.duration : ""),
    thumb: sample.poster || sample.image
  } : post.document ? {
    icon: "lucide:file-text",
    label: post.document.name || post.document.title || "Document"
  } : post.sharedProfile ? {
    icon: "lucide:user",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "pf-shq-body"
  }, post.body), shown.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "pf-shq-imgs"
  }, shown.map((src, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    className: "pf-shq-img"
  }, /*#__PURE__*/React.createElement("img", {
    src: src,
    alt: ""
  }), i === shown.length - 1 && extra > 0 && /*#__PURE__*/React.createElement("b", null, "+", extra)))), showKind && /*#__PURE__*/React.createElement("div", {
    className: "pf-shq-kind" + (kind.thumb ? " has-thumb" : "")
  }, kind.thumb && /*#__PURE__*/React.createElement("span", {
    className: "pf-shq-thumb"
  }, /*#__PURE__*/React.createElement("img", {
    src: kind.thumb,
    alt: ""
  }), /*#__PURE__*/React.createElement(IconifyIcon, {
    name: kind.live ? "lucide:radio" : "lucide:play",
    size: 16,
    color: "#fff"
  })), /*#__PURE__*/React.createElement("span", {
    className: "pf-shq-kind-tx"
  }, kind.live && /*#__PURE__*/React.createElement("b", {
    className: "pf-shq-live"
  }, "LIVE"), !kind.thumb && /*#__PURE__*/React.createElement(IconifyIcon, {
    name: kind.icon,
    size: 15,
    color: "var(--brand-navy)"
...
function ShareSheet({
  ...
  const submit = () => onShare({
    destKey: chosen.k,
    destLabel: chosen.k === "feed" ? "My feed" : chosen.label,
  ...
  const copyLink = () => {
    ...
    if (navigator.clipboard && navigator.clipboard.writeText) navigator.clipboard.writeText(sharePostUrl(post)).then(done, done);else done();
  };
  const openWhatsApp = () => window.open("https://wa.me/?text=" + encodeURIComponent(sharePostText(post) + " " + sharePostUrl(post)), "_blank", "noopener");
  const openEmail = () => {
    window.location.href = "mailto:?subject=" + encodeURIComponent(sharePostText(post)) + "&body=" + encodeURIComponent(sharePostText(post) + "\n\n" + sharePostUrl(post));
  };
  const moreShare = () => {
    if (navigator.share) navigator.share({
      title: "Profinity",
      text: sharePostText(post),
      url: sharePostUrl(post)
    }).catch(() => {});else copyLink();
  };
  const tiles = [{
    k: "copy",
  ...
  const sheet = /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-root" + (leaving ? " leaving" : "")
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pf-shs-scrim",
    "aria-label": "Close",
    onClick: close
  }), /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-sheet",
    role: "dialog",
    "aria-modal": "true",
    "aria-labelledby": "pf-shs-title",
    ref: sheetRef,
    tabIndex: -1
  }, /*#__PURE__*/React.createElement("span", {
    className: "pf-shs-grab",
    "aria-hidden": "true"
  }), /*#__PURE__*/React.createElement("header", {
    className: "pf-shs-hd"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-hd-tx"
    ...
    className: "pf-shs-scroll"
  }, /*#__PURE__*/React.createElement("section", {
    className: "pf-shs-compose",
    "aria-label": "Share to your feed"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-who"
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: ME.name,
    src: ME.avatar,
    size: 44
  }), /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-who-tx"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pf-shs-name"
  }, ME.name), /*#__PURE__*/React.createElement("span", {
    className: "pf-shs-chip-wrap"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pf-shs-chip" + (pop === "dest" ? " on" : ""),
    "aria-haspopup": "dialog",
    "aria-expanded": pop === "dest",
    onClick: () => setPop(p => p === "dest" ? null : "dest")
  }, chosen.k !== "feed" && /*#__PURE__*/React.createElement(IconifyIcon, {
    name: chosen.icon,
    size: 14,
    color: "currentColor"
  }), destName, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:chevron-down",
    size: 14,
    color: "currentColor"
  })), pop === "dest" && /*#__PURE__*/React.createElement(WebShareDrop, {
    label: "Share destination",
    className: "pf-shs-dd",
    onClose: () => setPop(null)
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-dd-hd"
    ...
    className: "tx"
  }, /*#__PURE__*/React.createElement("b", null, d.k === "feed" ? "Feed" : d.label), /*#__PURE__*/React.createElement("i", null, d.locked ? "Upgrade to share here" : d.sub)), !d.locked && pick === d.k && /*#__PURE__*/React.createElement("span", {
    className: "ck"
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:check",
    size: 12,
  ...
  }), pop === "emoji" && /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-emoji",
    role: "menu",
    "aria-label": "Pick an emoji"
  }, COMMENT_EMOJI.map(em => /*#__PURE__*/React.createElement("button", {
    key: em,
    ...
    className: "pf-shs-cta-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-tools"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pf-shs-tool" + (pop === "emoji" ? " on" : ""),
    "aria-label": "Add emoji",
    "aria-haspopup": "menu",
    "aria-expanded": pop === "emoji",
    ...
    type: "button",
    className: "pf-shs-tool" + (pop === "tag" ? " on" : ""),
    ...
    size: 27,
    color: "var(--gray-600)"
  })), pop === "tag" && /*#__PURE__*/React.createElement(WebShareDrop, {
    label: "Tag people",
    className: "pf-shs-dd up",
    onClose: () => setPop(null)
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-dd-hd"
  }, "Tag people"), SHARE_CONTACTS.map(p => /*#__PURE__*/React.createElement("button", {
    key: p.name,
    type: "button",
    className: "pf-share-dd-opt",
    onClick: () => {
      setPop(null);
      insertText((caption && !/\s$/.test(caption) ? " " : "") + "@" + p.name + " ");
    }
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: p.name,
    src: p.avatar,
    ...
    className: "tx"
  }, /*#__PURE__*/React.createElement("b", null, p.name))))))), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pf-shs-cta",
    onClick: submit
  }, "Share now"))), /*#__PURE__*/React.createElement("section", {
    className: "pf-shs-sec",
    "aria-label": "Send in Messages"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-sec-hd"
  }, /*#__PURE__*/React.createElement("b", null, "Send in Messages"), /*#__PURE__*/React.createElement("a", {
    href: "Messages.html",
    onClick: e => {
      e.preventDefault();
      (window.pfGo || (u => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      type: "button",
      role: "listitem",
      className: "pf-shs-contact" + (done ? " sent" : ""),
      ...
      name: done ? "lucide:check" : "lucide:send",
      size: 11,
      color: "currentColor"
    }))), /*#__PURE__*/React.createElement("span", {
      className: "nm"
    }, done ? "Sent" : shareFirstName(p.name)));
  }))), /*#__PURE__*/React.createElement("section", {
    className: "pf-shs-sec",
    "aria-label": "More ways to share"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-sec-hd"
  }, /*#__PURE__*/React.createElement("b", null, "More ways to share")), /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-tiles"
  }, tiles.map(t => /*#__PURE__*/React.createElement("button", {
    key: t.k,
    type: "button",
    className: "pf-shs-tile",
    onClick: t.onClick,
    style: {
      "--tone": SHARE_TILE_TONES[t.k]
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: "ic"
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: t.icon,
    size: 22,
    color: SHARE_TILE_TONES[t.k]
  })), /*#__PURE__*/React.createElement("span", {
    className: "lb"
  }, t.label)))))), note && /*#__PURE__*/React.createElement("div", {
    className: "pf-shs-note",
    role: "status"
  }, note)));
  const host = typeof document !== "undefined" && document.querySelector(".m-screen, .cm-screen, .lm-screen, .pm-screen, .ev-screen, .rl-screen");
...
const WEB_SHARE_AUDIENCES = [{
  k: "public",
  label: "Public",
  sub: "Anyone on Profinity",
  icon: "lucide:globe"
}, {
  k: "members",
  label: "Members",
  sub: "Profinity members only",
  icon: "lucide:users"
}, {
  k: "tier",
  label: "My tier",
  sub: "Members in your tier and above",
  icon: "lucide:crown"
}, {
  k: "me",
  label: "Only me",
...
function WebShareDrop({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "pfw-sh-dd" + (className ? " " + className : ""),
    role: "dialog",
    "aria-label": label
  }, children));
}
function WebShareModal({
  post,
  onClose,
  onShare
}) {
  ...
  const scrollRail = dir => {
    const el = railRef.current;
    if (el) el.scrollBy({
      left: dir * Math.max(200, el.clientWidth - 80),
      behavior: "smooth"
    });
  };
  ...
  const submit = () => onShare({
    destKey: chosen.k,
    destLabel: chosen.k === "feed" ? "your feed" : chosen.label,
    caption: caption.trim()
  });
  const sendTo = p => {
    if (sent[p.name]) return;
  ...
  const tiles = [{
    ...
    icon: "lucide:user-plus",
    onClick: () => setPop(p => p === "profile" ? null : "profile")
  }, {
    k: "email",
    label: "Email",
    icon: "lucide:mail",
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-overlay",
    onClick: onClose
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-modal",
    role: "dialog",
    "aria-modal": "true",
    "aria-labelledby": "pfw-sh-title",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("header", {
    className: "pfw-sh-top"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pfw-sh-title",
    id: "pfw-sh-title"
  }, "Share post"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pfw-cover-x pfw-sh-x",
    "aria-label": "Close",
    ref: closeRef,
    onClick: onClose
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    ...
    className: "pfw-sh-scroll"
  }, /*#__PURE__*/React.createElement("section", {
    className: "pfw-sh-compose",
    "aria-label": "Share to your feed"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-who"
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: ME.name,
    src: ME.avatar,
    size: 44
  }), /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-who-tx"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pfw-sh-name"
  }, ME.name), /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-chips"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pfw-sh-chip-wrap"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pfw-sh-chip" + (pop === "dest" ? " on" : ""),
    "aria-haspopup": "dialog",
    "aria-expanded": pop === "dest",
    onClick: () => setPop(p => p === "dest" ? null : "dest")
  }, chosen.k !== "feed" && /*#__PURE__*/React.createElement(IconifyIcon, {
    ...
    size: 13,
    color: "var(--text-primary)"
  }), chosen.k === "feed" ? "Feed" : chosen.label, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:chevron-down",
    size: 13,
    color: "var(--text-primary)"
  })), pop === "dest" && /*#__PURE__*/React.createElement(WebShareDrop, {
    ...
    type: "button",
    role: "radio",
    "aria-checked": !d.locked && dest === d.k,
    disabled: d.locked,
    ...
    className: "tx"
  }, /*#__PURE__*/React.createElement("b", null, d.k === "feed" ? "Feed" : d.label), /*#__PURE__*/React.createElement("i", null, d.locked ? "Upgrade to share here" : d.sub)), !d.locked && dest === d.k && /*#__PURE__*/React.createElement("span", {
    className: "ck"
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:check",
    size: 12,
    ...
    className: "pfw-sh-cta-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-tools"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pfw-sh-emoji-anchor"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pfw-sh-emoji" + (pop === "emoji" ? " on" : ""),
    "aria-label": "Add emoji",
    title: "Emoji",
    "aria-haspopup": "dialog",
    "aria-expanded": pop === "emoji",
    ...
    size: 26,
    color: "var(--gray-600)"
  })), pop === "emoji" && /*#__PURE__*/React.createElement(PfwPopover, {
    label: "Pick an emoji",
    width: 244,
    onClose: () => setPop(null)
  }, /*#__PURE__*/React.createElement("div", {
    ...
    type: "button",
    className: "pfw-sh-emoji" + (pop === "tag" ? " on" : ""),
    "aria-label": "Tag people",
    title: "Tag people",
    "aria-haspopup": "dialog",
    "aria-expanded": pop === "tag",
    ...
    className: "pfw-sh-dd-hd"
  }, "Tag people"), WEB_SHARE_CONTACTS.map(p => /*#__PURE__*/React.createElement("button", {
    key: p.name,
    type: "button",
    className: "pf-share-dd-opt",
    onClick: () => {
      setPop(null);
      insertEmoji((caption && !/\s$/.test(caption) ? " " : "") + "@" + p.name + " ");
    }
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: p.name,
    src: p.avatar,
    ...
    type: "button",
    className: "pfw-sh-cta",
    onClick: submit
  }, "Share now"))), /*#__PURE__*/React.createElement("section", {
    className: "pfw-sh-section",
    "aria-label": "Send in Messages"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-sec-hd"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "pfw-sh-rail-wrap"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-rail",
    ref: railRef,
    onScroll: syncRail,
    role: "list"
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      type: "button",
      role: "listitem",
      className: "pfw-sh-contact" + (done ? " sent" : ""),
      "aria-label": done ? "Sent to " + p.name : "Send to " + p.name,
      "aria-pressed": done,
      onClick: () => sendTo(p)
    }, /*#__PURE__*/React.createElement("span", {
  ...
  })), canNext && /*#__PURE__*/React.createElement("span", {
    className: "pfw-sh-rail-fade",
    "aria-hidden": "true"
  }), canPrev && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pfw-sh-rail-btn prev",
    ...
    size: 22,
    color: "var(--text-primary)"
  })), canNext && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pfw-sh-rail-btn next",
    ...
    className: "pfw-sh-tiles-wrap"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-tiles"
  }, tiles.map(t => /*#__PURE__*/React.createElement("button", {
    key: t.k,
    type: "button",
    className: "pfw-sh-tile" + (pop === "profile" && t.k === "profile" ? " on" : ""),
    onClick: t.onClick,
    style: {
      "--tone": SHARE_TILE_TONES[t.k]
    },
    ...
    className: "lb"
  }, t.label)))), pop === "profile" && /*#__PURE__*/React.createElement(WebShareDrop, {
    label: "Share to a member's profile",
    className: "up",
    onClose: () => setPop(null)
  }, /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-dd-hd"
  }, "Share to a member's profile"), WEB_SHARE_CONTACTS.map(p => /*#__PURE__*/React.createElement("button", {
    key: p.name,
    type: "button",
    className: "pf-share-dd-opt",
    onClick: () => {
      setPop(null);
      flash("Shared to " + firstName(p.name) + "'s profile");
    }
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: p.name,
    src: p.avatar,
    ...
    className: "tx"
  }, /*#__PURE__*/React.createElement("b", null, p.name)))))))), note && /*#__PURE__*/React.createElement("div", {
    className: "pfw-sh-note",
    role: "status"
  }, note)));
}
function FeedPost({
  ...
  const doShare = ({
    ...
    onShare({
      ...
      destKey,
      destLabel,
      sharedPost: slimSharedPost(post)
    });
  ...
  }), shareOpen && (typeof window !== "undefined" && !window.PF_EMBED ? /*#__PURE__*/React.createElement(WebShareModal, {
    post: post,
...
function ChannelFeedCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClose: () => setShareOpen(false),
    onShare: doShare
  })), shareToast && /*#__PURE__*/React.createElement("div", {
    className: "pf-share-toast",
    role: "status"
  }, shareToast), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(LikedByRow, {
    onOpen: () => setLikesOpen(true)
...
function CourseCommentCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "pf-share-toast",
    role: "status"
  }, shareToast), replying && /*#__PURE__*/React.createElement(CommentComposer, {
    placeholder: "Write a reply…",
    autoFocus: true,
    small: true,
    onSubmit: t => {
...
function writeExpandedPins(ids) {
  try {
    localStorage.setItem(PF_PINNED_EXPANDED_KEY, JSON.stringify(ids));
  } catch (e) {}
}
...
function PinnedMiniCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    src: thumb,
    alt: ""
  }) : kindIcon ? /*#__PURE__*/React.createElement("span", {
    className: "pf-pinned-mini-kind"
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: kindIcon,
    size: 20,
    color: "var(--brand-navy)"
...
function readPinsOpen() {
  try {
    return localStorage.getItem(PF_PINNED_OPEN_KEY) === "1";
  } catch (e) {
    return false;
  }
}
function writePinsOpen(open) {
  try {
    localStorage.setItem(PF_PINNED_OPEN_KEY, open ? "1" : "0");
  } catch (e) {}
}
function PinnedBox({
  items,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !embed && /*#__PURE__*/React.createElement("div", {
    ...
    className: "pf-pinned-box-avs",
    "aria-hidden": "true"
  }, authors.slice(0, 3).map((a, i) => /*#__PURE__*/React.createElement("span", {
    key: a.name,
    className: "pf-pinned-box-av",
    style: {
      marginLeft: i ? -10 : 0
    }
  }, /*#__PURE__*/React.createElement(Avatar, {
    ...
    className: "pf-pinned-box-count"
  }, n, " pinned ", n === 1 ? "post" : "posts"), /*#__PURE__*/React.createElement("span", {
    className: "pf-pinned-box-hint"
  }, open ? "Hide" : "Show"), /*#__PURE__*/React.createElement("span", {
    className: "pf-pinned-box-chev"
  }, /*#__PURE__*/React.createElement(IconifyIcon, {
    name: "lucide:chevron-down",
    size: 22,
    color: "var(--brand-navy)"
  }))), open && /*#__PURE__*/React.createElement("div", {
    className: "pf-pinned-box-list"
  }, items.map(x => {
    const expanded = expandedIds.includes(x.item.id);
    if (!expanded) {
      return /*#__PURE__*/React.createElement("div", {
        key: x.item.id,
        className: "pf-pinned-box-row"
      }, /*#__PURE__*/React.createElement(PinnedMiniCard, {
        post: x.item,
        onExpand: () => onToggleItem(x.item.id)
      }));
    }
    return /*#__PURE__*/React.createElement("div", {
      key: x.item.id,
      className: "pf-pinned-box-item"
    }, /*#__PURE__*/React.createElement("div", {
      className: "pf-pinned-box-item-bar"
    }, /*#__PURE__*/React.createElement("span", {
      className: "pf-pinned-box-item-lbl"
    }, /*#__PURE__*/React.createElement(IconifyIcon, {
      name: "fluent:pin-12-filled",
      size: 12,
      color: "var(--brand-gold)"
    }), "Pinned post"), /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "pf-pinned-card-tag-btn",
      onClick: () => onToggleItem(x.item.id),
      "aria-expanded": "true"
    }, "Minimize", /*#__PURE__*/React.createElement(IconifyIcon, {
      name: "lucide:chevron-up",
      size: 15,
      color: "currentColor"
    }))), renderItem(x));
...
function Feed({
  ...
  useEffect(() => {
    const onStorage = e => {
      if (!e.key || e.key === PF_USER_POSTS_KEY) setUserPosts(readUserPosts());
    };
  ...
  const setViewerPersona = key => {
    setUserTier(key);
    setViewerPersonaRaw(key);
  };
  ...
  useEffect(() => {
    let fromUrl = null;
    try {
      fromUrl = new URLSearchParams(window.location.search).get("post");
    } catch (e) {}
    if (!fromUrl) return;
  ...
  const shareFrom = (p, info) => {
    ...
    setTimeout(() => (window.pfGo || function (u) {
      window.location.href = u;
    })(url), 900);
  };
  ...
  const visibleFeedItems = channel ? [...userPosts.filter(p => !p.uploading && p.channelBucket === channel).map(p => ({
    item: p,
    mode: "full"
  })), ...bucketResolved.filter(({
    item: p
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    expandedIds: expandedPins,
    onToggleItem: toggleMinimizePin,
    renderItem: renderFeedItem,
    innerRef: pinnedRef
  }), regularItems.map(renderFeedItem), landToast && /*#__PURE__*/React.createElement("div", {
    className: "pf-save-toast",
    role: "status"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pf-save-toast-ck"
    ...
    className: "pf-save-toast-tx"
  }, landToast)), pinToast && /*#__PURE__*/React.createElement("div", {
    className: "pf-save-toast",
    role: "status"
  }, /*#__PURE__*/React.createElement("span", {
    className: "pf-save-toast-ck"
