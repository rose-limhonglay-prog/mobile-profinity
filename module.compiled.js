...
const {
  IconifyIcon: IcoMO,
  LevelBadge: LevelBadgeMO,
  ProgressBar: ProgressBarMO,
  Button: ButtonMO,
  Card: CardMO
} = DMO;
function goMO(url) {
...
const MO_DATA = {
  "module-1": {
    ...
    lessons: [["Treatment", "3:04"], ["Technique reducing the risk of Eyelid Ptosis", "2:14"], ["Treatment Avoidance", "5:24"]],
    subs: [],
    nextModule: "module-2"
  },
  "module-2": {
    ...
    lessons: [["Welcome & how to use this module", "2:10"], ["Safety essentials (watch first)", "6:48"]],
    subs: [{
      name: "Injection Techniques",
      n: 3,
      mins: "14 min",
      lessons: ["Linear threading technique", "Tenting technique", "Cannula approach"]
    }, {
      name: "Case Studies",
      n: 2,
      mins: "16 min",
      lessons: ["Case 1: thin lips, first treatment", "Case 2: correction of migrated filler"]
    }, {
      name: "Downloads & Resources",
      n: 2,
      mins: "2 files",
      lessons: ["Technique recipe cards (PDF)", "Consent form templates (PDF)"]
    }],
    nextModule: null
  }
};
...
Object.keys(MO_DATA).forEach(k => {
  MO_KEY_BY_INDEX[MO_DATA[k].level + ":" + MO_DATA[k].module] = k;
});
function moKey() {
  try {
...
function firstIncompleteMO(d, doneSet) {
  for (let i = 0; i < d.lessons.length; i++) {
    if (doneSet.indexOf(d.lessons[i][0]) === -1) return {
      url: lessonUrlMO(d, i)
    };
  }
  for (let si = 0; si < d.subs.length; si++) {
    ...
    for (let i = 0; i < s.lessons.length; i++) {
      if (doneSet.indexOf(s.lessons[i]) === -1) return {
        url: subLessonUrlMO(d, si, i)
      };
    }
  }
  return null;
...
function MOLesson({
  ...
  return /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "mo-lesson" + (done ? " done" : ""),
    onClick: () => goMO(lessonUrlMO(d, i))
  }, /*#__PURE__*/React.createElement("span", {
    className: "mo-lesson-n"
  }, done ? /*#__PURE__*/React.createElement(IcoMO, {
    name: "lucide:check",
    size: 14,
    color: "#fff"
  }) : n), /*#__PURE__*/React.createElement("span", {
    className: "mo-lesson-tx"
  }, /*#__PURE__*/React.createElement("span", {
    className: "nm"
    ...
    size: 13,
    color: "var(--gray-450)"
  }), pdf ? "Download" : l[1])), /*#__PURE__*/React.createElement(IcoMO, {
...
function MOSubRow({
  ...
  return /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "mo-sub",
    onClick: () => goMO(subModuleUrlMO(d, si))
  }, /*#__PURE__*/React.createElement("span", {
    className: "mo-sub-ic"
  }, /*#__PURE__*/React.createElement(IcoMO, {
    name: "lucide:folder",
    ...
    className: "mt"
  }, s.n, " lessons · ", s.mins)), /*#__PURE__*/React.createElement(IcoMO, {
    name: "lucide:chevron-right",
    size: 19,
    color: "var(--gray-450)"
  }));
...
function ModuleHome() {
  ...
  const doneN = d.lessons.filter(l => doneSet.indexOf(l[0]) !== -1).length + d.subs.reduce((a, s) => a + s.lessons.filter(n => doneSet.indexOf(n) !== -1).length, 0);
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mo-screen",
    "data-screen-label": "Module (mobile)"
    ...
    className: "mo-head-tx"
  }, /*#__PURE__*/React.createElement("span", {
    className: "h"
  }, d.course), /*#__PURE__*/React.createElement("span", {
    className: "s"
  }, d.name)), /*#__PURE__*/React.createElement("span", {
    className: "mo-top-sp"
  })), /*#__PURE__*/React.createElement("div", {
    className: "mo-scroll"
  }, /*#__PURE__*/React.createElement(CardMO, {
    className: "mo-hero"
  }, /*#__PURE__*/React.createElement("span", {
    className: "mo-kind"
  }, "Module"), /*#__PURE__*/React.createElement("div", {
    className: "mo-meta"
  }, /*#__PURE__*/React.createElement(LevelBadgeMO, {
    level: d.levelLabel
  }), /*#__PURE__*/React.createElement("span", {
    className: "mo-chip"
  }, /*#__PURE__*/React.createElement(IcoMO, {
    ...
    size: 15,
    color: "var(--brand-gold)"
  }), d.mins)), /*#__PURE__*/React.createElement("p", {
    className: "mo-desc"
  }, d.desc), /*#__PURE__*/React.createElement(ProgressBarMO, {
    value: pct,
    label: pct + "% Complete",
    style: {
      marginBottom: 16
    ...
    size: "lg",
    fullWidth: true,
    iconTrailing: /*#__PURE__*/React.createElement(IcoMO, {
    ...
    className: "mo-lessons",
    style: {
      padding: 0,
      overflow: "hidden"
    }
  }, d.lessons.map((l, i) => /*#__PURE__*/React.createElement(MOLesson, {
    key: i,
    d: d,
    l: l,
    n: i + 1,
  ...
  }))), d.subs.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "mo-sec-h"
  }, /*#__PURE__*/React.createElement("h2", null, "Sub-modules")), /*#__PURE__*/React.createElement("div", {
    className: "mo-subs"
  }, d.subs.map((s, si) => /*#__PURE__*/React.createElement(MOSubRow, {
    key: s.name,
    d: d,
    s: s,
    si: si
    ...
    variant: "secondary",
    fullWidth: true,
    iconLeading: /*#__PURE__*/React.createElement(IcoMO, {
      name: "lucide:list",
      size: 18,
      color: "var(--gray-600)"
    }),
    onClick: () => goMO("CourseDetail.html")
  }, "Back to course outline")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 24
    }
  })));
...
function ModuleApp() {
  ...
  if (mobile) {
    ...
    }, /*#__PURE__*/React.createElement(ModuleHome, null));
  }
  return /*#__PURE__*/React.createElement("div", {
...
ReactDOM.createRoot(document.getElementById("pf-root")).render(/*#__PURE__*/React.createElement(ModuleApp, null));
