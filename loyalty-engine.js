...
(function () {
  ...
  var DEFAULT_ACTIONS = [
    ...
    { id: "evt_profile_complete", label: "Complete Profile 100%", category: "Onboarding", basePoints: 200, dailyCap: null, weeklyCap: null, lifetimeCap: 1, velocitySeconds: 0, minCharacters: 0, requiresMedia: false, requiresApproval: false, holdDays: 0, platforms: ["web", "ios", "android"], active: true, oneTimeLock: true, guardrail: "One-time lock upon profile completion.", linkedReward: null },
