...
(function () {
  ...
  const MegaphoneIcon = () => /*#__PURE__*/React.createElement("svg", {
    width: "26",
    height: "26",
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  function Modal({
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "pf-cs-overlay " + variant + (className ? " " + className : ""),
      onClick: onCancel,
      "data-testid": "comment-share-prompt"
    }, /*#__PURE__*/React.createElement("div", {
      className: "pf-cs-card",
      onClick: e => e.stopPropagation(),
      role: "dialog",
      "aria-modal": "true",
      "aria-labelledby": "pf-cs-title"
    }, /*#__PURE__*/React.createElement("div", {
      className: "pf-cs-icon"
    }, /*#__PURE__*/React.createElement(MegaphoneIcon, null)), /*#__PURE__*/React.createElement("h3", {
      className: "pf-cs-title",
      id: "pf-cs-title"
    }, COPY.title), /*#__PURE__*/React.createElement("p", {
      className: "pf-cs-desc"
    }, COPY.desc), /*#__PURE__*/React.createElement("label", {
      className: "pf-cs-toggle-row"
    }, /*#__PURE__*/React.createElement("span", {
      className: "pf-cs-toggle-text"
    }, /*#__PURE__*/React.createElement("span", {
      className: "pf-cs-toggle-label"
    }, COPY.toggle), /*#__PURE__*/React.createElement("span", {
      className: "pf-cs-toggle-sub"
    }, COPY.toggleSub)), /*#__PURE__*/React.createElement("span", {
      className: "pf-cs-switch" + (share ? " on" : "")
      ...
      className: "pf-cs-knob"
    }))), /*#__PURE__*/React.createElement("label", {
      className: "pf-cs-remember"
    }, /*#__PURE__*/React.createElement("input", {
      type: "checkbox",
      checked: remember,
      onChange: e => setRemember(e.target.checked)
    }), COPY.remember), /*#__PURE__*/React.createElement("div", {
      className: "pf-cs-actions"
    }, /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "pf-cs-btn cancel",
      onClick: onCancel
    }, COPY.cancel), /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "pf-cs-btn primary",
  ...
  function Note({
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "pf-cs-note" + (className ? " " + className : "")
    }, /*#__PURE__*/React.createElement(HelpIcon, null), COPY.note);
  }
  ...
  function useSharePrompt(onPost, opts) {
    ...
    const submit = text => {
      const pref = readPref();
      if (pref) {
        onPost(text, !!pref.share);
        return;
      }
      setPending(text);
    };
    const cancel = React.useCallback(() => setPending(null), []);
    const modal = pending === null ? null : /*#__PURE__*/React.createElement(Modal, {
      variant: opts && opts.variant || "sheet",
